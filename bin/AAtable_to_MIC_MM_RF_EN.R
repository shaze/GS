...
PBP_AA_TO_MIC2<- function(cwd){
  ...
  m3=read.csv("newDB/BLOSUM62.csv", colClasses="character", header=T) 
  ...
  RFdbMIC=c("newDB/PEN_RandomForestMIC", "newDB/AMO_RandomForestMIC", "newDB/MER_RandomForestMIC",
	  "newDB/TAX_RandomForestMIC", "newDB/CFT_RandomForestMIC", "newDB/CFX_RandomForestMIC")  
  m3=m2$sampleID
  for (j1 in 1:6)
  {
    rm(fit1)
  ...
  RFdbBK1=c("newDB/PEN_RandomForestBK1", "newDB/AMO_RandomForestBK1", "newDB/MER_RandomForestBK1",
	  "newDB/TAX_RandomForestBK1", "newDB/CFT_RandomForestBK1", "newDB/CFX_RandomForestBK1")  
  m3=m2$sampleID
  for (j1 in 1:6)
  {
    rm(fit1)
  ...
  ENdbMIC=c("newDB/PEN_ElasticNetMIC", "newDB/AMO_ElasticNetMIC", "newDB/MER_ElasticNetMIC",
	  "newDB/TAX_ElasticNetMIC", "newDB/CFT_ElasticNetMIC", "newDB/CFX_ElasticNetMIC")  
  ...
  ENdbBK1=c("newDB/PEN_ElasticNetBK1", "newDB/AMO_ElasticNetBK1", "newDB/MER_ElasticNetBK1",
	  "newDB/TAX_ElasticNetBK1", "newDB/CFT_ElasticNetBK1", "newDB/CFX_ElasticNetBK1")  
