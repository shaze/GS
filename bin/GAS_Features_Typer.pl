...
printf "srst2 --samtools_args '\\-A' --input_pe $fastq1 $fastq2 --output $outNameFEAT --log --save_scores --min_coverage 99.9 --max_divergence 8 --gene_db $feat_DB\n";
